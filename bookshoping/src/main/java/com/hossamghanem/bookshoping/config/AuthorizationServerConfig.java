...
/**
 * @author Hossam Ghanem
 *  @EnableAuthorizationServer :- annotation is used to configure the OAuth 2.0 Authorization Server mechanism
 */
@EnableAuthorizationServer
@Configuration
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {

    public final static String CLIENT_APPLICATION_NAME = "bookshopping";
